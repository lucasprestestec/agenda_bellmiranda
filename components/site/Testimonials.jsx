...
export function Testimonials() {
  ...
  return (
    <section style={{ maxWidth: 'var(--container)', margin: '0 auto', padding: 'var(--section-y) var(--gutter)' }}>
      <SectionHeading align="center" eyebrow="Clientes" title="Elas voltam — e trazem amigas" maxWidth={520}
        style={{ margin: m ? '0 auto 34px' : '0 auto 56px' }} />
      <div style={{ display: 'grid', gridTemplateColumns: m ? '1fr' : 'repeat(3,1fr)', gap: m ? '30px' : '44px', alignItems: 'start' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', marginTop: m ? '36px' : '56px' }}>
        <Ornament width={m ? 160 : 220} motif="heart" color="var(--rose-500)" />
      </div>
    </section>
  );
}
