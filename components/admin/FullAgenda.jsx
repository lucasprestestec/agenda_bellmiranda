...
// The full Mês/Semana/Dia agenda — block management, edit, staff filter,
// everything. Lives as one component so /admin/agenda is the only place
// this logic exists, not copy-pasted between routes.
export function FullAgenda() {
  const m = useMobile();
  ...
  return (
    <>
      <main style={{ maxWidth: '1080px', margin: '0 auto', padding: m ? '20px var(--gutter) 24px' : '40px var(--gutter) 80px',
